...
const Header = () => {
  ...
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage: "url('/assets/header_img.png')"}} id='Header'>
        <Navbar/>
        <motion.div 
        initial={{opacity: 15, y:100}}
